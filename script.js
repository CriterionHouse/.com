...
$(function replaceText () { 
  count = 0; 
  wordsArray = [ 'High Quality', 'Modern', 'Research Driven', 'Innovative', 'Human Centric']; 
  setInterval(function replaceText() { 
    count++; 
    $("#changing").fadeOut(600, function () { 
...
$(function replaceNum () { 
  count = 0; 
  numArray = ['1', '2','3',  '10X', '15X', '20X' ]; 
  setInterval(function replaceNum() { 
    count++; 
    $("#number").fadeOut(1, function () { 
      $(this).text(numArray[count % numArray.length]).fadeIn(1); 
    }); 
  }, 3000); 
}); 
//End Replace Number function
